...
!function(a, b, c) {
    ...
    var d = function() {
        ...
        return _createClass(c, [{
            ...
            value: function() {
                var a = void 0
                    , b = [];
                return a = "undefined" == typeof this.ctx ? [] : this.ctx instanceof HTMLElement ? [this.ctx] : Array.isArray(this.ctx) ? this.ctx : Array.prototype.slice.call(this.ctx),
            ...
            value: function(a, b) {
                ...
                return this.opt.iframes || (e = e.concat(["iframe"])),
                ...
                try {
                    !function() {
                        var d = a.contentWindow
                            ...
                            var b = function b() {
                                try {
                                    h() || (a.removeEventListener("load", b),
                                        g())
                                } catch (a) {
                                    c()
                                }
            ...
            value: function(a, b) {
                var c = this
                    , d = arguments.length <= 2 || void 0 === arguments[2] ? function() {}
                    : arguments[2]
                    , e = 0
                    , f = function() {
                    --e < 1 && d()
            ...
            value: function(a) {
                var b = this
                    , c = arguments.length <= 1 || void 0 === arguments[1] ? function() {}
                    : arguments[1]
                    ...
                    f.forEach(function(c) {
                        if (!b.matchesExclude(c, d)) {
                            if ("iframe" === c.tagName.toLowerCase())
                                return void b.forEachElementInIframe(c, function(c) {
            ...
            value: function(a) {
                ...
                this.opt.className && (c += "." + this.opt.className),
                    ...
                    this.forEachElement(function(a) {
    ...
    c.fn.mark = function(a, b) {
        return new d(this).mark(a, b),
            this
    }
        ,
        c.fn.markRegExp = function(a, b) {
            return new d(this).markRegExp(a, b),
                this
        }
        ,
        c.fn.unmark = function(a) {
            return new d(this).unmark(a),
                this
        }
}, window, document);
